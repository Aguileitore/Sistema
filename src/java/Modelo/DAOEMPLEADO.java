...
public class DAOEMPLEADO extends Conexion {
    ...
    public void registrarUsuarios(nomina nom) throws Exception {
        String sql;
        sql = "INSERT INTO empleado (NOMBRE, APELLIDOS, TELEFONO, FECHANACIMIENTO, TIPODOCUMENTO, NUMERODOCUMENTO)"
                + "VALUES ('" + nom.getNombre() + "', '"
                + nom.getApellidos() + "', "
                + nom.getTelefono() + "', "
                + nom.getNacimiento() + "', "
                + nom.getDocumento() + "', "
